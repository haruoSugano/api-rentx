...
var CarsRepositoryInMemory = /** @class */ (function () {
    ...
    CarsRepositoryInMemory.prototype.create = function (_a) {
        var name = _a.name, brand = _a.brand, category_id = _a.category_id, daily_rate = _a.daily_rate, description = _a.description, fine_amount = _a.fine_amount, license_plate = _a.license_plate, id = _a.id;
