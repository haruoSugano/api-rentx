...
var ListCategoriesController = /** @class */ (function () {
    ...
    ListCategoriesController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var listCategoryUseCase, all;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listCategoryUseCase = tsyringe_1.container.resolve(ListCategoriesUseCase_1.ListCategoriesUseCase);
                        return [4 /*yield*/, listCategoryUseCase.execute()];
                    case 1:
                        all = _a.sent();
