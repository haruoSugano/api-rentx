...
var SendForgotPasswordMailController = /** @class */ (function () {
    ...
    SendForgotPasswordMailController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var email, sendForgotPasswordMailUseCase;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = request.body.email;
                        sendForgotPasswordMailUseCase = tsyringe_1.container.resolve(SendForgotPasswordMailUseCase_1.SendForgotPasswordMailUseCase);
                        return [4 /*yield*/, sendForgotPasswordMailUseCase.execute(email)];
                    case 1:
                        _a.sent();
