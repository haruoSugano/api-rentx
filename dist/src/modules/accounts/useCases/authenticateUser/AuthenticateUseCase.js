...
var AuthenticateUseCase = /** @class */ (function () {
    function AuthenticateUseCase(usersRepository, usersTokensRepository, dayjsDateProvider) {
        this.usersRepository = usersRepository;
        this.usersTokensRepository = usersTokensRepository;
        this.dayjsDateProvider = dayjsDateProvider;
    }
    AuthenticateUseCase.prototype.execute = function (_a) {
        var email = _a.email, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var user, secret_token, secret_refresh_token, expires_in_token, expires_in_refresh_token, expires_refresh_token_days, passwordMatch, token, refresh_token, refresh_token_expires_date, tokenReturn;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.usersRepository.findByEmail(email)];
                    case 1:
                        user = _b.sent();
                        secret_token = auth_1.default.secret_token, secret_refresh_token = auth_1.default.secret_refresh_token, expires_in_token = auth_1.default.expires_in_token, expires_in_refresh_token = auth_1.default.expires_in_refresh_token, expires_refresh_token_days = auth_1.default.expires_refresh_token_days;
                        if (!user) {
    ...
    AuthenticateUseCase = __decorate([
