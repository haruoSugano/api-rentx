...
var UpdateUserAvatarUseCase = /** @class */ (function () {
    function UpdateUserAvatarUseCase(usersRepository, storageProvider) {
        this.usersRepository = usersRepository;
        this.storageProvider = storageProvider;
    }
    UpdateUserAvatarUseCase.prototype.execute = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.storageProvider.delete(user.avatar, "avatar")];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3: return [4 /*yield*/, this.storageProvider.save(avatar_file, "avatar")];
                    case 4:
                        _b.sent();
