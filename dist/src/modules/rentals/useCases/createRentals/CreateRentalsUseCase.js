...
exports.CreateRentalsUseCase = void 0;
var AppError_1 = require("@shared/errors/AppError");
var tsyringe_1 = require("tsyringe");
var CreateRentalsUseCase = /** @class */ (function () {
    function CreateRentalsUseCase(rentalsRepository, dateProvider, carsRepository) {
        this.rentalsRepository = rentalsRepository;
        this.dateProvider = dateProvider;
        this.carsRepository = carsRepository;
    }
    CreateRentalsUseCase.prototype.execute = function (_a) {
        var user_id = _a.user_id, car_id = _a.car_id, expected_return_date = _a.expected_return_date;
        return __awaiter(this, void 0, void 0, function () {
            var minimumHour, carUnavailable, rentalOpenToUser, dateNow, compare, rental;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (rentalOpenToUser) {
                            throw new AppError_1.AppError("There's a rental in progress for use!");
                        }
                        dateNow = this.dateProvider.dateNow();
                        compare = this.dateProvider.compareInHours(dateNow, expected_return_date);
                        if (compare < minimumHour) {
                            throw new AppError_1.AppError("Invalide return time!");
                        }
    ...
    CreateRentalsUseCase = __decorate([
    ...
    ], CreateRentalsUseCase);
    return CreateRentalsUseCase;
}());
exports.CreateRentalsUseCase = CreateRentalsUseCase;
