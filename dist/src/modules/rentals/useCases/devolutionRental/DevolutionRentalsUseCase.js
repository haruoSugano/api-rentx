...
exports.DevolutionRentalsUseCase = void 0;
var tsyringe_1 = require("tsyringe");
var DayjsDateProvider_1 = require("@shared/container/providers/DateProvider/implementations/DayjsDateProvider");
var AppError_1 = require("@shared/errors/AppError");
var DevolutionRentalsUseCase = /** @class */ (function () {
    function DevolutionRentalsUseCase(rentalsRepository, carsRepository, dateProvider) {
        this.rentalsRepository = rentalsRepository;
        this.carsRepository = carsRepository;
        this.dateProvider = dateProvider;
    }
    DevolutionRentalsUseCase.prototype.execute = function (_a) {
        var id = _a.id, user_id = _a.user_id;
        return __awaiter(this, void 0, void 0, function () {
            var rental, car, minium_daily, dateNow, daily, delay, total, calculate_fine;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        delay = this.dateProvider.compareInDays(dateNow, rental.start_date);
                        total = 0;
                        if (delay > 0) {
    ...
    DevolutionRentalsUseCase = __decorate([
    ...
    return DevolutionRentalsUseCase;
}());
exports.DevolutionRentalsUseCase = DevolutionRentalsUseCase;
