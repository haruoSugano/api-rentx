...
class LocalStorageProvider {
  async save(file, folder) {
    await _fs.default.promises.rename((0, _path.resolve)(_upload.default.tmpFolder, file),
    // De onde
    (0, _path.resolve)(`${_upload.default.tmpFolder}/${folder}`, file) // Para onde sera enviado
    );
